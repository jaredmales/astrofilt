...
if (aname eq 'cptrans_zm' or aname eq 'mktrans_zm' ) then begin
   ...
   fname = strcompress(datadir + '/atm/' + aname + '_'  + string(pwv*10., format='(I)') + '_' + $ 
...
if (aname eq 'paranal') then begin
   ...
   fname1 = strcompress(datadir + '/atm/' + 'paranal_airm' + string(am, format='(F0.2)') + '_wav00.4-03.0.dat', /rem)
   
   fname2 = strcompress(datadir + '/atm/' + 'paranal_airm' + string(am, format='(F0.2)') + '_wav03.0-06.0.dat', /rem)
